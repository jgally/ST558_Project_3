...
```
    ...
    ## 1 No               27.1  5.98    12    98     7
    ## 2 Pre              31.4  7.06    14    98     8
...
![](College_Graduate_files/figure-gfm/unnamed-chunk-6-3.png)<!-- -->
...
![](College_Graduate_files/figure-gfm/unnamed-chunk-6-4.png)<!-- -->
...
![](College_Graduate_files/figure-gfm/unnamed-chunk-6-5.png)<!-- -->
...
![](College_Graduate_files/figure-gfm/unnamed-chunk-6-6.png)<!-- -->
...
![](College_Graduate_files/figure-gfm/unnamed-chunk-6-7.png)<!-- -->
...
![](College_Graduate_files/figure-gfm/unnamed-chunk-6-8.png)<!-- -->
...
```
    ...
    ## Log Loss on Testing Set: 2.006935
...
```
    ...
    ## Best Complexity Parameter: 0.07
...
```
    ...
    ## 
    ## 1) root 250 40 No (0.8400000 0.1600000) *
...
```
    ...
    ## Log Loss on Testing Set: 1.323187
...
```
    ...
    ## Log Loss on Testing Set: 0.8180787
...
```
    ...
    ## Log Loss on Testing Set: 0.3313118
...
```
    ...
    ## Log Loss on Testing Set: 34.43258
...
```
    ...
    ## The best model is: Logistic_Model with log loss: 0.3313118
