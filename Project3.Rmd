---
title: "Project 3 - diabetes_data: `r params$Education` Analysis""
...
In this section we change most of the variables into factors and label them with appropriate names.  
...
#Fitting an oblique random forest model
#ada_fit <- train(Diabetes_binary ~ ., data = training, 
                #method = "Adaboost.M1", 
                #trControl = control,
                #metric = "logLoss")
#print(Rot_fit)
...
best_of_best <- c(Lasso_Model = Lasso, Tree_Model = Tree, Cart_Model = Cart, Logistic_Model = Logistic)  
